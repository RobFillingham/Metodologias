...
import { EstimationFunctionService } from '../../../../core/services/cocomo-ii-stage3/estimation-function.service';
import { EstimationFunction, CreateEstimationFunctionRequest, UpdateEstimationFunctionRequest, FunctionType, FUNCTION_TYPES, ApiResponse } from '../../../../core/models/cocomo-ii-stage3/cocomo-ii-stage3.models';

@Component({
  selector: 'app-function-point-entry-stage3',
  standalone: true,
...
export class FunctionPointEntryStage3Component implements OnInit {

...
export class EstimationFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const request: CreateEstimationRequest = {
      ...
      selectedEmPers: formValue.selectedEmPers,
      selectedEmRcpx: formValue.selectedEmRcpx,
      selectedEmPdif: formValue.selectedEmPdif,
      selectedEmPrex: formValue.selectedEmPrex,
      selectedEmRuse: formValue.selectedEmRuse,
      selectedEmFcil: formValue.selectedEmFcil,

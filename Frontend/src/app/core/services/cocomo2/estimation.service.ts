...
import { ApiResponse, Estimation, CreateEstimationRequest, UpdateEstimationRatingsRequest, UpdateEstimationActualResultsRequest } from '../../models/cocomo2/cocomo.models';
...
export class EstimationService {
  ...
  getEstimationsByProject(projectId: number): Observable<ApiResponse<Estimation[]>> {
    return this.apiService.get<Estimation[]>(`Projects/${projectId}/Estimations`);
  }
  ...
  getEstimation(projectId: number, estimationId: number): Observable<ApiResponse<Estimation>> {
    return this.apiService.get<Estimation>(`Projects/${projectId}/Estimations/${estimationId}`);
  }
  ...
  createEstimation(projectId: number, request: CreateEstimationRequest): Observable<ApiResponse<Estimation>> {
    return this.apiService.post<Estimation>(`Projects/${projectId}/Estimations`, request);
  }
  ...
  updateEstimationRatings(projectId: number, estimationId: number, request: UpdateEstimationRatingsRequest): Observable<ApiResponse<Estimation>> {
    return this.apiService.put<Estimation>(`Projects/${projectId}/Estimations/${estimationId}/Ratings`, request);
  }
  ...
  updateEstimationActualResults(projectId: number, estimationId: number, request: UpdateEstimationActualResultsRequest): Observable<ApiResponse<Estimation>> {
    return this.apiService.put<Estimation>(`Projects/${projectId}/Estimations/${estimationId}/ActualResults`, request);
  }
  ...
  deleteEstimation(projectId: number, estimationId: number): Observable<ApiResponse<void>> {
    return this.apiService.delete<void>(`Projects/${projectId}/Estimations/${estimationId}`);
  }
}
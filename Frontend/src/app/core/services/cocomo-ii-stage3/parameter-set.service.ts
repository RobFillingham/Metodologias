...
import { ApiResponse, ParameterSet, CreateParameterSetRequest } from '../../models/cocomo-ii-stage3/cocomo-ii-stage3.models';
...
export class ParameterSetService {
  ...
  getMyParameterSets(): Observable<ApiResponse<ParameterSet[]>> {
    return this.apiService.get<ParameterSet[]>('CocomoIIStage3/ParameterSets/my');
  }
  ...
  getDefaultParameterSets(): Observable<ApiResponse<ParameterSet[]>> {
    return this.apiService.get<ParameterSet[]>('CocomoIIStage3/ParameterSets/default');
  }
  ...
  getParameterSet(id: number): Observable<ApiResponse<ParameterSet>> {
    return this.apiService.get<ParameterSet>(`CocomoIIStage3/ParameterSets/${id}`);
  }
  ...
  createParameterSet(request: CreateParameterSetRequest): Observable<ApiResponse<ParameterSet>> {
    return this.apiService.post<ParameterSet>('CocomoIIStage3/ParameterSets', request);
  }
  ...
  updateParameterSet(id: number, request: CreateParameterSetRequest): Observable<ApiResponse<ParameterSet>> {
    ...
    return this.apiService.put<ParameterSet>(`CocomoIIStage3/ParameterSets/${id}`, updateRequest);
  }
  ...
  deleteParameterSet(id: number): Observable<ApiResponse<void>> {
    return this.apiService.delete<void>(`CocomoIIStage3/ParameterSets/${id}`);
  }
}
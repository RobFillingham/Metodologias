...
/// <summary>
/// Controller for managing COCOMO II Stage 3 projects
/// </summary>
[ApiController]
[Route("api/CocomoIIStage3/[controller]")]
[Authorize]
[Produces("application/json")]
[Tags("COCOMO II Stage 3 - Projects")]
public class ProjectsController : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<IEnumerable<ProjectDto>>>> GetUserProjects()
    {
        ...
        catch (Exception ex)
        {
            ...
            var response = ApiResponse<IEnumerable<ProjectDto>>.ErrorResponse(
    ...
    public async Task<ActionResult<ApiResponse<ProjectDto>>> GetProjectById(int id)
    {
        ...
        catch (Exception ex)
        {
            ...
            var response = ApiResponse<ProjectDto>.ErrorResponse(
